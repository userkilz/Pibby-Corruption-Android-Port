...
function onEvent(name, value1, value2)
	...
	function onUpdate()
		if getProperty('boyfriend.animation.curAnim.name') == 'singLEFT' or 'singLEFT-alt' then
			bfColor = 'f44336'
		end
		if getProperty('boyfriend.animation.curAnim.name') == 'singRIGHT' or 'singRIGHT-alt' then
			bfColor = 'ee2288'
		end
		if getProperty('boyfriend.animation.curAnim.name') == 'singUP' or 'singUP-alt' then
			bfColor = '28c71f'
		end
		if getProperty('boyfriend.animation.curAnim.name') == 'singDOWN' or 'singDOWN-alt' then
			bfColor = '3d85c6'
		end
	end
else
